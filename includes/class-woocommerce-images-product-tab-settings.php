...
class WooCommerce_Images_Product_Tab_Settings {

	/**
	 * The single instance of WooCommerce_Images_Product_Tab_Settings.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function add_settings_link ( $links ) {
		...
		$settings_link = '<a href="admin.php?page=' . $this->parent->_token . '">' . __( 'Settings', 'woocommerce-images-product-tab' ) . '</a>';
	...
	public function settings_page () {
		...
		$html = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			$html .= '<h2>' . __( $plugin_data['Name'] , 'woocommerce-images-product-tab' ) . '</h2>' . "\n";
	...
	/**
	 * Main WooCommerce_Images_Product_Tab_Settings Instance
	 *
	 * Ensures only one instance of WooCommerce_Images_Product_Tab_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see WooCommerce_Images_Product_Tab()
	 * @return Main WooCommerce_Images_Product_Tab_Settings instance
	 */
